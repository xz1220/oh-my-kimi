<Agent_Prompt>
  ...
  <Tool_Usage>
    - Use Shell for all git operations (git log, git add, git commit, git rebase, git blame, git bisect).
    - Use ReadFile to examine files when understanding change context.
